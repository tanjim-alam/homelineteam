        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
            <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200/50 sticky top-0 z-50">
                <div className="px-6 py-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Kitchen Products</h1>
                        <p className="text-gray-600">Manage dynamic kitchen catalog</p>
                    </div>
                    <button
                ...
                {showForm && (
                    <div className="mx-6 bg-white rounded-2xl border p-6 shadow">
                        <div className="flex items-center justify-between mb-4">
                            <div className="font-semibold text-lg">{editing ? 'Edit' : 'Add'} Kitchen Product</div>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    {layoutOptions.map(layout => (
                                        <button
                                            ...
                                            className={`p-3 rounded border text-left text-sm ${form.defaultLayout?.type === layout.type
                            ...
                            {/* Default Appliances */}
                            <div>
                                <label className="block text-sm font-medium mb-2">Default Appliances</label>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    {applianceOptions.map(appliance => {
                                        const selected = form.defaultAppliances.some(x => x.id === appliance.id);
                                        return (
                                            <label key={appliance.id} className="flex items-center gap-2 text-sm">
                                                <input
                                                    type="checkbox"
                                                    checked={selected}
                                                    onChange={() => {
                                                ...
                                                />
                                                <span>{appliance.name} {appliance.essential && '(Essential)'}</span>
                                            </label>
                                        );
                                    })}
                                </div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {suitableForOptions.map(option => (
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded text-sm ${form.kitchenMetadata.suitableFor.includes(option)
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {styleOptions.map(option => (
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded text-sm ${form.kitchenMetadata.style.includes(option)
                                                    ? 'bg-orange-100 text-orange-800 border border-orange-300'
                                                    : 'bg-gray-100 text-gray-700 border border-gray-300'
                                                    }`}
                                            >
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {colorSchemeOptions.map(option => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded text-sm ${form.kitchenMetadata.colorScheme.includes(option)
                                                ? 'bg-orange-100 text-orange-800 border border-orange-300'
                                                : 'bg-gray-100 text-gray-700 border border-gray-300'
                                                }`}
                                        >
                            ...
                            <div className="flex justify-end gap-3 pt-2">
                                ...
                                <button
                                    type="submit"
                                    disabled={saving}
                                    className="px-5 py-2 bg-orange-600 text-white rounded disabled:opacity-50"
                                >
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600">Layout</th>
