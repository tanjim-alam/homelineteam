                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 sticky top-8">
                                <nav className="space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="group w-full flex items-center gap-3 px-4 py-3 rounded-xl text-primary-600 hover:bg-primary-50 transition-all duration-200"
                                    >
                                        <XCircle className="w-5 h-5 text-primary-500 group-hover:text-primary-600" />
                        ...
                        <div className="lg:col-span-3">
                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-8">
                                {/* Alert Messages */}
                                {error && (
                                    <div className="mb-6 p-4 bg-primary-50 border-l-4 border-primary-500 rounded-lg flex items-center gap-3">
                                        <XCircle className="w-5 h-5 text-primary-500 flex-shrink-0" />
                                        <p className="text-primary-700 font-medium">{error}</p>
                                    </div>
                                )}
