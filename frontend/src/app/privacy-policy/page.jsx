        ...
        },
        {
            ...
            content: (
                <div className="space-y-6">
                    ...
                    <div className="bg-primary-50 border-l-4 border-primary-400 p-6 rounded-r-lg">
                        <h4 className="text-lg font-semibold text-primary-900 mb-3">When We May Collect Without Consent</h4>
                    ...
                    <div className="text-center text-white">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                            <div className="text-center">
                                ...
                                <p className="text-primary-100 text-sm">support@homelineteam.com</p>
                            </div>
                            <div className="text-center">
                                <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-primary-100 text-sm">+91-9611 925 494</p>
                            </div>
                            <div className="text-center">
                                <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-primary-100 text-sm">India</p>
                            </div>
                        </div>
                    </div>
                </div>
