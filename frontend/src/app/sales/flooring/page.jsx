...
const WA_MSG = encodeURIComponent(
  '🛍️ Hi! I saw your flooring ad on Google. I am interested in ordering flooring. Please share details and pricing.'
)

export const metadata = {
  title: 'Premium SPC Flooring | HomelineTeam',
  description: 'Shop premium waterproof SPC & vinyl flooring online. Best prices. Free shipping across India.',
  robots: { index: false },
}
...
export default function FlooringLandingPage() {
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container-custom">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base max-w-md mx-auto">
              Our flooring experts are available 7 days a week. Share your room size and we'll suggest the best options within your budget.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                Premium waterproof flooring, curtains, blinds & wallpapers delivered and installed across India.
              </p>
      ...
      {/* Floating custom flooring button */}
