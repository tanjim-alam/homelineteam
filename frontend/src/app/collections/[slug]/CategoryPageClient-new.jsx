  ...
  const Sidebar = () => (
    <div className="bg-white lg:sticky lg:top-4 p-4">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-200">
        ...
        {activeCount() > 0 && (
          <button onClick={clearAllFilters} className="text-xs text-gray-500 hover:text-primary-600 underline underline-offset-2 transition-colors">
        ...
        <div className="container-custom py-10">
          {subcategories.length === 0 ? (
            <div className="text-center py-20">
              ...
              <Link href="/collections" className="text-sm text-primary-600 hover:text-primary-700 font-semibold">
                Back to Collections
              </Link>
            </div>
          ) : (
                  ...
                  <Link key={sub._id} href={`/collections/${sub.slug}`} className="group block">
                    <article className="relative rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-gray-100 aspect-square">
                      ...
                      <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300">
                        <span className="flex items-center gap-1 bg-white text-primary-600 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-3 mb-4 flex flex-col sm:flex-row items-center justify-between gap-3">
              <p className="text-sm text-gray-500">
                ...
                {activeCount() > 0 && (
                  <span className="text-primary-600 ml-1">· {activeCount()} filter{activeCount() !== 1 ? 's' : ''}</span>
                )}
              </p>
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="border border-gray-200 text-gray-700 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 cursor-pointer"
                >
            ...
            {products.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
                ...
                <Link
                  href="/collections"
                  className="inline-flex items-center gap-2 bg-primary-600 text-white px-5 py-2.5 rounded-xl hover:bg-primary-700 transition-colors font-semibold text-sm"
                >
