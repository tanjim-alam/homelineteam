          ...
          <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="relative">
              ...
              <input
                ...
                autoComplete="off"
                className="w-full pl-12 pr-32 py-4 text-gray-800 text-base border-2 border-gray-200 rounded-2xl
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-primary-600 text-white
                           px-5 py-2.5 rounded-xl hover:bg-primary-700 transition-colors duration-200
                           disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer text-sm font-semibold"
              >
                Search
              </button>
            </form>
