              ...
              <div className="space-y-6 lg:space-y-8 text-white text-center lg:text-left w-full lg:w-1/2">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                  <Link href="/collections">
                    <button className="bg-white cursor-pointer text-gray-900 hover:bg-gray-100 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg transition-all duration-300 group flex items-center justify-center gap-2 shadow-lg w-full sm:w-auto">
                      <span>Shop Now</span>
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform duration-300" />
                    </button>
                  </Link>
                  <Link href="/interior-design">
                    <button className="border-2 border-white cursor-pointer text-white hover:bg-white hover:text-gray-900 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg transition-all duration-300 group flex items-center justify-center gap-2 backdrop-blur-sm w-full sm:w-auto">
