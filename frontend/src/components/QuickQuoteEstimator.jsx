  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-20 lg:bottom-8 right-4 sm:right-6 lg:right-8 w-14 h-14 bg-primary-600 hover:bg-primary-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-40 flex items-center justify-center group ${className}`}
      ...
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-primary-600 to-rose-700 px-6 py-5 flex-shrink-0 relative">
              <button
                onClick={handleClose}
            ...
            <div className="overflow-y-auto flex-1 p-5 space-y-5">
              ...
              {success ? (
                <div className="text-center py-10">
                  ...
                  <button
                    onClick={handleClose}
                    className="bg-primary-600 hover:bg-primary-700 text-white font-bold px-8 py-2.5 rounded-xl transition-colors"
                  >
                    Done
                  </button>
                </div>
                ...
                <>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                      Home Type <span className="text-primary-500">*</span>
                    </label>
                  ...
                  <div className="space-y-3">
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider">
                      Your Details <span className="text-primary-500">*</span>
                    </label>
                  ...
                  {formData.homeType && (
                    <div className="bg-primary-50 border border-primary-100 rounded-xl px-4 py-3 text-center">
                      <p className="text-[11px] text-primary-400 font-medium uppercase tracking-wider mb-0.5">Your Project</p>
            ...
            {!success && (
              <div className="flex-shrink-0 px-5 pb-5 pt-3 border-t border-gray-100 flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-bold py-3 rounded-xl transition-colors"
                >
                  {submitting
                    ? 'Submitting…'
