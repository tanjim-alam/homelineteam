...
const stats = [
  { value: '50K+', label: 'Happy Customers', color: 'text-primary-400'     },
...
export default function WhyChooseUs() {
  return (
    ...
    >
      {/* ── Ambient glow blobs ─────────────────────────────────────────── */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary-600/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[200px] bg-primary-900/10 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 lg:gap-12 mb-7">
          ...
          <div>
            <h2 id="why-choose-heading" className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-2 leading-tight">
              The{' '}
              <span className="bg-gradient-to-r from-primary-400 to-rose-500 bg-clip-text text-transparent">
                HomelineTeam
              </span>
              {' '}Difference
            </h2>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <h3 className="text-white font-bold text-sm group-hover:text-primary-300 transition-colors">
                          {f.title}
                        </h3>
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* CTA card */}
            <div className="bg-gradient-to-br from-primary-600 to-rose-700 rounded-xl p-4 relative overflow-hidden">
              ...
              <Link
                href="/contact"
                className="relative z-10 inline-flex items-center gap-1.5 bg-white text-primary-600 hover:bg-primary-50 text-xs font-bold px-3 py-1.5 rounded-lg transition-colors"
              >
        ...
        <div className="border-t border-white/[0.07] pt-5 flex flex-wrap items-center justify-center gap-x-5 gap-y-2.5">
          {trust.map((item) => (
            <span key={item} className="flex items-center gap-2 text-xs text-gray-500 font-medium">
              <CheckCircle className="w-3.5 h-3.5 text-primary-500/70 flex-shrink-0" />
              {item}
            </span>
          ))}
        </div>
